...
A number of base textures' alpha channels also had to be edited/converted in order to function properly with ray tracing without altering their original appearance. 
